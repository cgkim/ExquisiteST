...
- (void)_configureDefaults {
  ...
  _pager.hidesForSinglePage = YES;
    ...
    if ([_pager respondsToSelector:@selector(setPageIndicatorTintColor:)]) {
        _pager.pageIndicatorTintColor = [UIColor colorWithRed:189/255.0 green:189/255.0 blue:189/255.0 alpha:1.0];
        _pager.currentPageIndicatorTintColor = [UIColor colorWithRed:164/255.0 green:199/255.0 blue:255/255.0 alpha:1.0];
    }
